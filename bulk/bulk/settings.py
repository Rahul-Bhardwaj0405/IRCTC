...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'Account_Test',        # Directly specify your database name
        'USER': 'PG_TESTING',       # Directly specify your database user
        'PASSWORD': '12345',        # Directly specify your database password
        'HOST': '172.28.58.14',     # Directly specify your database host
        'PORT': '5433',             # Directly specify your database port
    }
}
...
STATIC_ROOT = "E:/Bulk_V1/bulk/static/"
...
#         'OPTIONS': {
#             'CLIENT_CLASS': 'django_redis.client.DefaultClient',
#             'TIMEOUT': 3600  # Adjust TTL to keep cache entries long enough
#         }
#     }
# }
